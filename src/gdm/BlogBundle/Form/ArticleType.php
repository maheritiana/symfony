...
class ArticleType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
       ...
       /* Rappel :
        - 1er argument : nom du champ, ici « categories », car c'est lenom de l'attribut
        - 2e argument : type du champ, ici « collection » qui est une liste de quelque chose
        - 3e argument : tableau d'options du champ*/
            ->add('categories', 'entity', array('class' => 'gdmBlogBundle:Categorie','property' => 'nom','multiple' => true,'expanded' => false));
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'gdm\BlogBundle\Entity\Article'
        ));
    }
