 ...
 */
class Commentaire extends \gdm\BlogBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'auteur', 'contenu', 'date', 'article');
    }
